...
class ProjectFullTextScreeningConflictResolutionController extends Controller
{
    public function store(
        Request $request,
        Project $project,
        ProjectScreeningConflict $conflict,
        ResolveProjectFullTextScreeningConflict $resolveConflict,
    ): RedirectResponse {
        ...
        Inertia::flash('toast', ['type' => 'success', 'message' => __('Full-text screening conflict resolved.')]);

        return to_route('projects.full-text-screening.index', [
            'project' => $project,
